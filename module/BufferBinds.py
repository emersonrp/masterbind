...
class BufferBinds(Module):
    ...
    #               }
    #       })
    #       my exportbtn = cbButton("Export...",sub { cbExportModuleSettings(profile,n,bbinds,"BuffBind") })
    #
    ...
    #       }
        ...
        def createDialog(bbinds, profile):
            pass
    #       my box = {}
    ...
    #               my newbbind = newBBind() #  we will be filling this new BBind up.
    #               table.insert(bbinds,newbbind)
    #               my newbbind_n = table.getn(bbinds)
